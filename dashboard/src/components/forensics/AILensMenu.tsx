    ...
    <div ref={wrapperRef} className="relative">
      <div className="inline-flex rounded-lg overflow-hidden border border-ai">
        ...
        >
          {loading ? (
            <>
              <div className="h-3.5 w-3.5 border-2 border-ink border-t-transparent rounded-full animate-spin" />
              Analyzing...
            </>
          ) : (
            <>
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-2 w-80 rounded-lg border border-line bg-surface shadow-2xl z-30 overflow-hidden"
        >
          <div className="px-3 py-2 border-b border-line text-xs font-semibold text-subtle uppercase tracking-wider">
            Focused AI Lenses
          </div>
          {lenses.map((lens) => {
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-sm font-medium text-ink">{lens.label}</div>
