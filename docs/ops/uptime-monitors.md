...
5. Confirm each monitor's notification channel routes to
   `120221487+Levaj2000@users.noreply.github.com` (or the on-call alias, once we have one).
...
Current: email to `120221487+Levaj2000@users.noreply.github.com`. Good enough for solo founder.
