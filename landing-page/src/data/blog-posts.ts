    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "At AI Identity, we're building the infrastructure that makes this possible — [per-agent identity](/product), [scoped permissions](/product), [tamper-proof audit trails](/forensics), and policy enforcement at the gateway level. Because the future of enterprise AI isn't just about what agents can do. It's about proving what they did.",
