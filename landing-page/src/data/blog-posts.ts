    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "AI Identity's agent registry provides a foundation here. Every registered agent has structured metadata — name, description, capabilities, policy bindings, and version history. This metadata forms the core of your technical documentation. The [compliance assessment](/security) feature maps this data directly to EU AI Act requirements, identifying gaps before an auditor does.",
        ],
      },
      {
        ...
        content: [
          ...
          "AI Identity's [tamper-evident audit trail](/forensics) was designed for exactly this requirement. Every request through the gateway is logged with the agent's identity, the action taken, the policy evaluation result, timestamps, and an HMAC-SHA256 hash chain that makes any tampering detectable. The audit trail is exportable as JSON or CSV with a chain-of-custody verification certificate — exactly what a regulator needs to see.",
        ],
      },
      {
        ...
        content: [
          ...
          "AI Identity's policy engine supports this through scoped permissions (agents can only access what they are explicitly allowed to), real-time monitoring via the [dashboard](/request-services), instant agent revocation through key management, and a fail-closed gateway design where any uncertainty results in a denied request. The planned human-in-the-loop review feature will add explicit approval workflows for sensitive agent actions — a direct response to Article 14's oversight requirements.",
        ],
      },
      {
        ...
        content: [
          ...
          "Practically, this means running regular compliance assessments against your agent fleet. AI Identity's [compliance framework](/security) automates this — you can run assessments against EU AI Act requirements, NIST AI RMF, and SOC 2 controls at any time. Each assessment produces a scored report with specific findings and remediation guidance. Schedule these weekly or monthly, not just before an audit.",
        ],
      },
      {
        ...
        content: [
          ...
          "May 2026: Implement per-agent identity and logging. Every high-risk agent should have a unique identity, scoped permissions, and a tamper-evident audit trail. If you are starting from shared API keys and application-level logs, this is the biggest lift.",
      ...
      },
      {
        ...
        content: [
          ...
          "The companies that will deploy agents successfully in the post-regulation era are the ones investing in governance infrastructure now. Per-agent identity, scoped permissions, tamper-evident audit trails, automated compliance assessments, and human oversight tooling. This is not overhead — it is the foundation that makes agent deployment possible in any regulated industry.",
          "AI Identity provides this infrastructure in a [15-minute integration](/request-services). Register your agents, set their policies, route their API calls through our gateway, and you have identity, policy enforcement, forensic logging, and compliance evidence built in. Start with the [free tier](/pricing) — five agents, full audit trail, EU AI Act compliance assessments included.",
      ...
      },
      {
        ...
        content: [
          ...
          "The good news is that the technical controls required by these frameworks overlap significantly. Per-agent identity, scoped permissions, tamper-evident audit trails, and human oversight capabilities satisfy requirements across all of them. Invest in the infrastructure once and you have compliance evidence for multiple frameworks. AI Identity's [compliance dashboard](/pricing) maps your agent fleet's posture against EU AI Act, SOC 2, NIST AI RMF, and GDPR simultaneously.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Your compliance team uses forensics to prove governance. When an auditor asks for evidence that your agents operate within defined policies, they need tamper-evident records with cryptographic verification. Forensics is the right tool for this job.",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "[Identity](/product) answers the question: who is this agent? Every agent gets a unique, verifiable identity with scoped API keys and lifecycle management. Without identity, there is no accountability. AI Identity's agent registry provides each agent with a cryptographic fingerprint, structured metadata, and a complete version history — the foundation that every other pillar builds on.",
          "[Policy](/product) answers: what is this agent allowed to do? A fail-closed gateway evaluates every request against the agent's policy before it proceeds. No policy evaluation, no access — no exceptions. Policies are versioned and immutable — when you update a policy, the previous version is preserved in the audit trail, so you can always determine what rules were in effect at any point in time.",
          "[Compliance](/security) answers: can we prove the rules were followed? Automated compliance evaluators map agent behavior to frameworks like SOC 2 Type II, NIST AI RMF, and the EU AI Act. Evidence is generated continuously, not assembled retroactively before an audit. The EU AI Act alone carries fines of up to 35 million EUR or 7% of global annual turnover for violations of prohibited practices — these are not theoretical penalties.",
      ...
      },
      {
        ...
        content: [
          ...
          "Start by [registering your agents](/request-services) — each gets a unique identity with scoped permissions. Define policies that govern what each agent can access. Route their API calls through the AI Identity gateway. Every action is now authenticated, policy-checked, and logged to a tamper-evident audit trail with HMAC-SHA256 chain verification.",
      ...
      },
      {
        ...
        content: [
          ...
          "What compliance frameworks does AI Forensics support? AI Identity's forensic layer produces evidence that maps to EU AI Act requirements (Articles 9, 11, 12, and 14), NIST AI RMF documentation standards, SOC 2 Type II controls for AI systems, and GDPR data processing accountability requirements. The [compliance assessment](/security) feature generates scored reports against each framework.",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "At AI Identity, we solve this with a [gateway-based architecture](/product) that assigns every agent a unique cryptographic identity. Each agent gets its own API key, its own set of scoped permissions defined by [policy](/product), and its own entry in the agent registry with structured metadata — name, description, capabilities, version history, and policy bindings. The gateway sits between the agent and the APIs it calls, verifying identity and enforcing policy on every single request.",
      ...
      },
      {
        ...
        content: [
          ...
          "Provisioning: when a new agent is deployed, it is registered in the [agent registry](/request-services) with structured metadata — its name, purpose, capabilities, owning team, and the policies that govern its behavior. This registration creates the agent's identity and generates its unique API credentials.",
          "Policy binding: each agent is bound to one or more [policies](/product) that define exactly what it can do. A customer service agent might be allowed to call the GPT-4 API with a specific system prompt but blocked from accessing any other model or endpoint. Policies are evaluated at the gateway level, not the application level — the agent cannot bypass its own restrictions.",
      ...
      },
      {
        ...
        content: [
          ...
          "If you want to understand how identity fits into the broader governance picture, read about the [four pillars of agent governance](/blog/introducing-ai-forensics) or explore how AI Identity handles [compliance](/security) across EU AI Act, SOC 2, NIST AI RMF, and GDPR frameworks.",
        ],
      },
      {
        heading: "Frequently Asked Questions",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "The practical benefit is significant. When an auditor requests evidence — or when a regulator sends an inquiry — you can produce a complete, verified compliance record within minutes, not weeks. AI Identity's [compliance assessment](/security) feature runs evaluations against EU AI Act, SOC 2, NIST AI RMF, and GDPR requirements at any time, producing scored reports with specific findings and remediation guidance. Schedule these assessments weekly or monthly to maintain continuous visibility into your compliance posture.",
        ],
      },
      {
        ...
        content: [
          ...
          "This means investing in identity and governance infrastructure now, before regulators mandate it. It means treating compliance not as a checkbox exercise but as a competitive advantage. When a prospect asks 'how do you govern your AI agents?' and you can show them per-agent identity, scoped permissions, tamper-evident audit trails, and automated compliance assessments — that is a sales advantage that no model benchmark can match.",
          "At AI Identity, we're building the infrastructure that makes this possible — [per-agent identity](/product), [scoped permissions](/product), [tamper-evident audit trails](/forensics), and policy enforcement at the gateway level. Because the future of enterprise AI isn't just about what agents can do. It's about proving what they did.",
      ...
      },
      {
        ...
        content: [
          ...
          "Start by [registering your agents](/request-services) with unique identities and scoped permissions. Route their API calls through the AI Identity gateway so every action is authenticated, authorized, and logged. Run a [compliance assessment](/security) against the frameworks that apply to your organization — EU AI Act, SOC 2, NIST AI RMF, GDPR — and identify gaps before an auditor does.",
      ...
      },
      {
        ...
        content: [
          ...
          "Do I need separate compliance infrastructure for each framework? No. The technical controls required by major compliance frameworks overlap significantly. Per-agent identity, scoped permissions, tamper-evident audit trails, and policy enforcement satisfy requirements across EU AI Act, SOC 2, NIST AI RMF, and GDPR. AI Identity generates framework-specific evidence from the same underlying infrastructure.",
