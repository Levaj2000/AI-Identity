...
function CheckIcon() {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
      fill="none"
      className="shrink-0 text-[rgb(166,218,255)]"
    >
      <path
...
function XIcon() {
  return (
    <svg
      ...
      viewBox="0 0 16 16"
      fill="none"
      className="shrink-0 text-[rgba(184,199,217,0.3)]"
    >
      <path
...
function UsageEstimator() {
  ...
  const tierColorMap: Record<string, string> = {
    Free: "text-[rgba(213,219,230,0.7)]",
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-white/10 bg-[rgb(16,19,28)]/80 backdrop-blur-xl p-8">
        <div className="mb-6">
          ...
          <p className="mt-1.5 text-sm text-[rgba(184,199,217,0.5)] ml-[26px]">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm text-[rgba(213,219,230,0.7)]">Active agents</label>
            ...
            <input
              ...
              className="w-full h-1.5 rounded-full bg-[rgb(16,19,28)] appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[rgb(166,218,255)]"
            />
            <div className="flex justify-between mt-1 text-[10px] text-[rgba(184,199,217,0.3)]">
              <span>1</span>
              <span>50</span>
              <span>100</span>
              <span>200</span>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm text-[rgba(213,219,230,0.7)]">
          ...
          <div className="rounded-xl bg-white/[0.03] border border-white/5 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-[rgba(184,199,217,0.5)] uppercase tracking-wider">
                  Estimated monthly volume
                </p>
                <p className="mt-1 text-xl font-bold text-white">
                  {totalRequests.toLocaleString()}{" "}
                  <span className="text-sm font-normal text-[rgba(184,199,217,0.5)]">
                    requests/mo
                  </span>
                </p>
              </div>
              <div className="text-right">
                ...
                <p className="text-sm text-[rgba(184,199,217,0.5)]">{recommended.price}</p>
              </div>
            </div>
          </div>

          <p className="text-xs text-[rgba(184,199,217,0.3)] leading-relaxed">
...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 px-6 bg-[rgb(16,19,28)]">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.03] px-4 py-2">
            <span
              className={`text-sm font-medium transition-colors ${!annual ? "text-white" : "text-[rgba(184,199,217,0.5)]"}`}
            >
              Monthly
            </span>
            <button
              onClick={() => setAnnual(!annual)}
              className={`relative h-6 w-11 rounded-full transition-colors ${annual ? "bg-[rgb(166,218,255)]" : "bg-[rgb(26,37,64)]"}`}
            ...
            <motion.div
              ...
              className={`relative rounded-2xl p-8 flex flex-col ${
                tier.featured
                  ...
                  : "bg-[rgb(16,19,28)]/80 backdrop-blur-xl border border-white/10"
              }`}
            >
              {tier.featured && (
              ...
              <p className="mt-1 text-sm text-[rgba(184,199,217,0.5)]">{tier.description}</p>
              <div className="mt-4 flex items-baseline gap-1">
                <span className="text-4xl font-bold text-white">
                  {displayPrice}
                </span>
                {period && (
                  <span className="text-[rgba(184,199,217,0.5)] text-sm">{period}</span>
                )}
              </div>
              {annual && !isCustom && tier.monthlyPrice > 0 && (
                <p className="mt-1 text-xs text-[rgba(184,199,217,0.3)]">
                  <span className="line-through">${tier.monthlyPrice}/mo</span>
                  {" "}
                  <span className="text-[rgb(166,218,255)]">
              ...
              <ul className="mt-8 flex-1 space-y-3">
                {tier.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-start gap-2 text-sm text-[rgba(213,219,230,0.7)]"
                  >
              ...
              <a
                ...
                className={`mt-8 w-full py-3 rounded-lg text-sm font-semibold transition-colors text-center block ${
                  tier.featured
                    ...
                    : "border border-white/20 text-white hover:border-[rgb(166,218,255)]/40 hover:bg-white/5"
                }`}
              >
                {tier.cta}
              </a>
        ...
        {/* ── Trust signal under the tier CTAs ─────────────────────── */}
            ...
            <table className="w-full max-w-6xl mx-auto">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="py-4 px-4 text-left text-sm font-medium text-[rgba(184,199,217,0.5)] w-1/4">
                    Feature
                  </th>
                  <th className="py-4 px-4 text-center text-sm font-medium text-[rgba(213,219,230,0.7)]">
                    Free
                  </th>
                  <th className="py-4 px-4 text-center text-sm font-semibold text-[rgb(166,218,255)]">
                    Pro
                  </th>
                  <th className="py-4 px-4 text-center text-sm font-medium text-[rgba(213,219,230,0.7)]">
                    Business
              ...
              >
                ...
                >
                  ...
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="none"
                    className={`shrink-0 text-[rgba(184,199,217,0.5)] transition-transform duration-200 ${
                ...
                {openFaq === i && (
                  <div className="px-6 pb-4">
                    <p className="text-sm text-[rgba(213,219,230,0.7)] leading-relaxed">
                      {faq.a}
                    </p>
                  </div>
                )}
