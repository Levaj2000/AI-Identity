  ...
  return (
    <>
      <SEO
        ...
        description="Compare AI Identity and Credo AI for AI governance. See why teams choose AI Identity for runtime enforcement, per-agent identity, and accessible pricing over Credo AI's enterprise-only platform."
        path="/vs/credo-ai"
      />
