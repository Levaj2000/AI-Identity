      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 mb-12">
          <p className="text-sm text-gray-300 leading-relaxed">
            These Terms of Service (&ldquo;Terms&rdquo;) govern your use of the AI Identity platform and services operated by AI Identity LLC, a Colorado limited liability company. Please read these terms carefully before using our services.
          </p>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center">
          ...
          <a href="mailto:jeff@ai-identity.co?subject=Terms%20Inquiry" className="text-sm text-[rgb(166,218,255)] hover:underline">
            jeff@ai-identity.co
          </a>
        </div>
      </div>
