...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "AI Identity works with every major LLM provider. Drop-in gateway integration with OpenAI, Anthropic, Google Gemini, and 100+ models. Change one URL.",
  path: "/integrations",
});
      ...
      <section className="pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
            Works With Your <span className="text-[rgb(166,218,255)]">Entire Stack</span>
          </h1>
        ...
        <div className="max-w-[800px] mx-auto">
          <div className="bg-[rgb(166,218,255)]/5 border border-[rgb(166,218,255)]/20 rounded-2xl p-8 text-center">
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link href="/docs" className="inline-flex items-center gap-2 px-6 py-3 bg-[rgb(166,218,255)] text-[rgb(4,7,13)] font-semibold rounded-xl hover:bg-[rgb(166,218,255)]/80 transition-colors">
                Read the Docs
