...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Compare AI Identity with traditional IAM solutions like Okta and Auth0. Learn why human-centric identity systems cannot govern autonomous AI agents and what to use instead.",
