...
export const metadata: Metadata = generatePageMetadata({
  title: "AI Forensics for Financial Services",
  description: "Forensic-grade audit trails for AI agents in finance. HMAC-chained logs + DSSE-signed attestations satisfy SEC, FINRA, MiFID II, EU AI Act, SOC 2, PCI-DSS, and NYDFS examiners — verifiable offline.",
...
const regulations = [
  ...
  { name: "FINRA Rules 3110 & 4511", detail: "Broker-dealers must supervise automated systems and preserve complete, accurate books and records — including the activity of AI agents acting on the firm's behalf." },
  { name: "MiFID II", detail: "EU investment firms running algorithmic trading must keep detailed, time-sequenced records of every order and decision, sufficient for regulators to reconstruct what happened." },
...
const complianceMapping = [
  ...
  { framework: "FINRA Rules 3110 & 4511", requirement: "Supervision and books-and-records for automated systems", capability: "Tamper-evident, chained record of every agent action, exportable on demand" },
  { framework: "MiFID II", requirement: "Reconstructible records of algorithmic trading decisions", capability: "Time-sequenced audit chain with forensic replay of any decision" },
      ...
      <section className="pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
            ...
            <span className="text-[rgb(166,218,255)]">Financial AI</span>
          </h1>
          <p className="text-lg text-gray-400 max-w-[640px] mx-auto leading-relaxed">
            SEC, FINRA, MiFID II, EU AI Act — financial regulators want proof of oversight for every AI-driven decision, not a promise. AI Identity gives every trading, lending, and compliance agent a cryptographic, tamper-evident audit trail your examiner can verify offline. Built for the most regulated industry on earth.
          </p>
        </div>
      </section>
