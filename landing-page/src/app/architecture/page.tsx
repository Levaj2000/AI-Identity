  ...
  └──────────────────┘`}
      ...
      <Section id="properties">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <Card icon={icons.globe} title="Public Evidence Anchor" description="Roughly every 15 minutes, new audit events are committed to a signed Merkle checkpoint — and the checkpoint history itself is published on a public feed and mirrored off our infrastructure. Any single event can be proven part of the committed record with nothing but our published public key, and rewriting history would break against copies we don't control." />
      ...
      <Section id="security-layers">
        ...
        <div className="relative max-w-[700px] mx-auto">
          ...
          {[
            ...
            { icon: icons.globe, title: "Public Evidence Anchor", desc: "Audit events are committed to signed Merkle checkpoints on a continuous ~15-minute cadence, and the full checkpoint history is served on a public, unauthenticated feed with an independently held mirror. A single event can be proven part of the committed record with the published public key alone — without disclosing any other event." },
          ].map((layer, i) => (
