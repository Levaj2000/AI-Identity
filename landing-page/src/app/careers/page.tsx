...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Join AI Identity and help build the identity infrastructure for autonomous AI agents. Open positions in engineering, security, and go-to-market.",
  path: "/careers",
});
  ...
  return (
    <section className="pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-[700px] mx-auto text-center">
        <div className="mb-10">
          <div className="w-24 h-24 mx-auto rounded-full bg-[rgb(166,218,255)]/10 flex items-center justify-center text-5xl">
            &#x1F680;
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          <div className="p-6">
            ...
            <h4 className="text-sm font-semibold text-white mb-2">Ship Fast</h4>
            <p className="text-xs text-gray-500">We move quickly, iterate constantly, and put working software in front of users.</p>
          </div>
          <div className="p-6">
            <div className="text-2xl mb-3">&#x1F510;</div>
