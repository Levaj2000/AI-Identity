...
const solutions = [
  {
    ...
    description: "Every agent action is cryptographically chained. Any tampering breaks the chain and is immediately detectable — and a signed attestation lets any auditor verify it independently, offline.",
      ...
      <section className="pb-24 px-6 md:px-12">
        <div className="max-w-[800px] mx-auto">
          <div className="bg-[rgb(166,218,255)]/5 border border-[rgb(166,218,255)]/20 rounded-2xl p-8 text-center">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-3">Ready for examiner-ready AI agents?</h2>
