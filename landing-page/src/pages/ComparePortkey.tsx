...
const shortcomings = [
  ...
  {
    title: "No Compliance Dashboards",
    description:
      "Portkey offers no built-in assessments for EU AI Act, SOC 2, or NIST AI RMF. Teams must build their own compliance reporting layer on top of raw logs.",
  },
  {
    title: "No Chain-of-Thought Forensics",
    description:
      "When an agent misbehaves, Portkey cannot replay the reasoning steps that led to the action. You see the input and output, but not the decision-making process in between.",
  },
];
...
const differentiators = [
  {
    ...
    description:
      "Every agent gets a unique aid_sk_ key tied to a verifiable identity. Revoke, rotate, or scope credentials per agent without disrupting your fleet.",
    icon: (
  ...
  },
  {
    ...
    description:
      "AI Identity Pro starts at $79/mo with up to 50 agents. Portkey Pro is $59.99/mo but lacks identity, compliance, and forensics — the features that matter most in production.",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      <SEO
        ...
        description="Compare AI Identity and Portkey for AI agent management. See why teams choose AI Identity for per-agent identity, tamper-proof audit trails, and compliance dashboards over Portkey's LLM gateway."
        path="/vs/portkey"
      />
      ...
      <section className="pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
            AI Identity vs{" "}
            <span className="text-[rgb(166,218,255)]">Portkey</span>
          </h1>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-[1fr_100px_100px] md:grid-cols-[1fr_140px_140px] text-sm">
              ...
              <div className="px-3 py-4 border-b border-white/10 font-semibold text-gray-400 text-center">Portkey</div>
              {/* Rows */}
              {features.map((row, i) => (
                <>
      ...
      <section className="pb-20 px-6 md:px-12">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 text-center">
            Where Portkey Falls Short for AI Agents
          </h2>
          <p className="text-sm text-gray-400 text-center mb-10 max-w-[560px] mx-auto">
            Portkey optimizes LLM calls. It does not govern the agents making them.
          </p>
      ...
      <section className="pb-20 px-6 md:px-12">
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-sm text-gray-400 text-center mb-10 max-w-[560px] mx-auto">
            Purpose-built identity and governance for autonomous AI agents.
          </p>
