import svgPaths from "./svg-xx1eiznviq";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Plug AI Identity into your existing stack with minimal friction and maximum security.
      </p>
    </div>
  );
}
...
function Column1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Column">
      <TaglineWrapper1 />
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] min-w-full relative shrink-0 text-[36px] text-black w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function SectionTitle1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Section Title">
      <Column1 />
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        AI Identity integrates cleanly into your existing development environment. No rewrites. No friction. Just security that fits.
      </p>
    </div>
  );
}
...
function Content23() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 text-black w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.4] relative shrink-0 text-[20px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        OpenAI
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ContentLeft() {
  return (
    <div className="relative shrink-0 w-full" data-name="Content Left">
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <ContentLeft />
      <div className="h-[375px] relative shrink-0 w-full" data-name="Placeholder Image">
...
function Layout2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Layout / 536 /">
      <Container2 />
    </div>
  );
}
...
function Content34() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`Every endpoint explained. Every integration pattern covered. We've written the guides so you don't have to guess.`}</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <ContentLeft1 />
      <div className="aspect-[375/375] relative shrink-0 w-full" data-name="Placeholder Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPlaceholderImage} />
      </div>
    </div>
  );
...
function Layout1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Layout / 528 /">
      <Container3 />
    </div>
  );
}
...
export default function IntegrationsMobile() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Integrations • Mobile">
      <Navbar />
      <Header />
      <Layout />
      <Layout2 />
