import svgPaths from "./svg-jq22fnqvcn";
...
import imgTabPane1 from "figma:asset/d568b164c26b35eebe6a407c03f478bc8049c84b.png";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        The proxy gateway manages authentication for autonomous systems at scale.
      </p>
    </div>
  );
}
...
function Actions1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0" data-name="Actions">
      <div className="bg-black content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '/how-it-works'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Learn
        </p>
      </div>
      <div className="content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '/integrations'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Integrations
        </p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Three steps to secure autonomous systems
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        From zero to production in 15 minutes. The proxy gateway authenticates agent keys, validates requests with least-privilege enforcement, and logs every action to an audit trail.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        The system receives an authentication attempt from your autonomous agent.
      </p>
    </div>
  );
}
...
function Column1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-center min-h-px min-w-px relative" data-name="Column">
      <div className="relative shrink-0 size-[48px]" data-name="request_page">
        <div className="absolute inset-[7.69%_16.02%_7.71%_16.04%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.61 40.61">
            <path d={svgPaths.p19c23ff0} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content23 />
...
function Content24() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        The gateway verifies credentials against fail-closed security policies with least-privilege scoping before proceeding.
      </p>
    </div>
  );
}
...
function Column2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-center min-h-px min-w-px relative" data-name="Column">
      <div className="relative shrink-0 size-[48px]" data-name="security">
        <div className="absolute inset-[8.02%_16.02%_8.15%_16.04%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.61 40.236">
            <path d={svgPaths.p26f65700} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content24 />
...
function Content25() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Only authenticated agents with explicit permissions receive scoped API keys. All actions logged to an append-only audit trail.
      </p>
    </div>
  );
}
...
function Actions2() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="Actions">
      ...
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip relative shrink-0" data-name="Button" onClick={() => window.location.href = '/how-it-works'} style={{cursor:'pointer'}}>
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Explore
        </p>
...
function Content28() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-black w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Verified agent identity on every request
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        The gateway verifies every agent's API key against its hashed record before any request proceeds. No shortcuts. No exceptions.
      </p>
    </div>
  );
}
...
function FeatureOne() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Feature one">
      ...
      <div aria-hidden="true" className="absolute border-white/10 border-solid border-t inset-0 pointer-events-none" />
    </div>
  );
}
...
function Content31() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-black w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Inspect and enforce policy compliance
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`Each request is examined against your defined policies. The gateway enforces rules without hesitation, blocking what shouldn't pass.`}</p>
    </div>
  );
}
...
function Content34() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-black w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Controlled access with automatic expiration
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        API keys can be rotated or revoked instantly, with configurable grace periods for safe transitions. Control remains yours at every step.
      </p>
    </div>
  );
}
...
function TabsContent() {
  return (
    <div className="aspect-[600/600] content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative" data-name="Tabs Content">
      <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Tab Pane 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgTabPane1} />
      </div>
    </div>
  );
}
...
function TabHorizontal() {
  return (
    <div className="bg-white h-[130px] relative shrink-0 w-full" data-name="Tab Horizontal">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pl-[32px] relative size-full text-black">
          <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.3] relative shrink-0 text-[32px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Transparent operation always
          </p>
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Watch every decision the gateway makes in real time. Full visibility into authentication flows means no surprises when your agents are running.
          </p>
        </div>
      </div>
...
function TabHorizontal1() {
  return (
    <div className="h-[130px] relative shrink-0 w-full" data-name="Tab Horizontal">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pl-[32px] relative size-full text-black">
          <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.3] relative shrink-0 text-[32px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Real-time monitoring built in
          </p>
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`Metrics stream continuously as requests flow through the system. You see what's happening the moment it happens, not after the fact.`}</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="h-[130px] relative shrink-0 w-full" data-name="Tab Horizontal">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pl-[32px] relative size-full text-black">
          ...
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Connect your existing frameworks directly. The gateway speaks the language your agents already use.
          </p>
        </div>
      </div>
    </div>
...
function TabsMenu() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[40px] items-start min-h-px min-w-px relative" data-name="Tabs Menu">
      <TabHorizontal />
      <TabHorizontal1 />
      <TabHorizontal2 />
    </div>
...
function Layout() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Layout / 219 /">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[64px] py-[112px] relative w-full">
          <Container6 />
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] min-w-full relative shrink-0 text-[18px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Explore integrations or start protecting your autonomous systems today.
      </p>
    </div>
  );
}
...
export default function HowItWorksDesktop() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="How It Works • Desktop">
      <Navbar />
      <Header1 />
      <Layout1 />
      <Layout2 />
