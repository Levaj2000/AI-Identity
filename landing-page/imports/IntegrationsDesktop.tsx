import svgPaths from "./svg-nxxokt50gd";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Plug AI Identity into your existing stack. Scoped API keys and audit trails from day one.
      </p>
    </div>
  );
}
...
function Actions1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0" data-name="Actions">
      <div className="bg-black content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '/integrations'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Explore
        </p>
      </div>
      <div className="content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '#docs'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Docs
        </p>
...
function SectionTitle1() {
  return (
    <div className="content-stretch flex gap-[80px] items-start relative shrink-0 w-full" data-name="Section Title">
      <Column1 />
      <p className="flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[18px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
        AI Identity integrates cleanly into your existing development environment. No rewrites. No new dependencies. Just security that fits.
      </p>
    </div>
  );
}
...
function Content23() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Native support for GPT models and fine-tuned deployments across all versions.
      </p>
    </div>
  );
}
...
function Content22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[48px]" data-name="support">
        <div className="absolute inset-[7.69%_7.69%_7.71%_7.71%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.61 40.61">
            <path d={svgPaths.p3393f200} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content23 />
...
function Content25() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Native SDK for chains, agents, and memory systems. 15-minute setup with zero code changes to existing workflows.
      </p>
    </div>
  );
}
...
function Content24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[48px]" data-name="lan">
        <div className="absolute inset-[7.76%_11.93%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.55 40.55">
            <path d={svgPaths.p30c56100} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content25 />
...
function Content27() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Connect to any model in the Hub with identity verification built into the pipeline.
      </p>
    </div>
  );
}
...
function Content26() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[48px]" data-name="hub">
        <div className="absolute inset-[-1.02%_-0.87%_3.32%_-0.85%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48.825 46.8965">
            <path d={svgPaths.p2cd07500} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content27 />
...
function Content29() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Identity-aware multi-agent orchestration. Each crew member gets least-privilege access to tools and APIs.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[48px]" data-name="token">
        <div className="absolute inset-[8.62%_11.93%_8.72%_11.93%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.55 39.676">
            <path d={svgPaths.p363dd200} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content29 />
...
function Content36A() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Secure conversational agents with per-agent API keys and conversation-scoped permissions for multi-turn workflows.
      </p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-h-px min-w-px relative" data-name="Content">
      <div className="relative shrink-0 size-[48px]" data-name="settings">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46.5 46.5">
            <path d={svgPaths.p30c56100} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
...
function Row() {
  return (
    <div className="content-stretch flex gap-[32px] items-start justify-center relative shrink-0 w-full flex-wrap" data-name="Row">
      <Content22 />
      <Content24 />
      <Content28 />
      <Content36 />
...
function Actions2() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="Actions">
      <div className="relative shrink-0" data-name="Button" onClick={() => window.location.href = '#docs'} style={{cursor:'pointer'}}>
      ...
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip relative shrink-0" data-name="Button" onClick={() => window.location.href = '/integrations'} style={{cursor:'pointer'}}>
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          View all
        </p>
...
function Layout() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Layout / 308 /">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[64px] py-[112px] relative w-full">
          <Container2 />
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-black w-full" data-name="Content">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Build with our API and SDK
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Drop AI Identity into your codebase in minutes. Our API handles the heavy lifting while you focus on what matters. Clean, minimal, effective.
      </p>
    </div>
  );
}
...
function ContentLeft() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="Content Left">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="content-stretch flex flex-col items-end justify-center pl-[64px] pr-[80px] py-[112px] relative size-full">
          <Content30 />
        </div>
      </div>
    </div>
...
function Container3() {
  return (
    <div className="content-stretch flex h-[733px] items-start relative shrink-0 w-full" data-name="Container">
      <ContentLeft />
...
function Layout2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-full" data-name="Layout / 536 /">
      <Container3 />
    </div>
  );
}
...
function Content34() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-black w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>{`Every endpoint explained. Every integration pattern covered. We've written the guides so you don't have to guess.`}</p>
    </div>
  );
}
        ...
        <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon / chevron-right">
          <div className="absolute inset-[23.07%_35.77%_29.38%_34.55%]" data-name="icon">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.121 11.414">
              <path d={svgPaths.p34980b80} fill="var(--fill-0, black)" id="icon" />
            </svg>
          </div>
        </div>
      </div>
...
function Layout1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-full" data-name="Layout / 528 /">
      <Container4 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-black text-center w-full" data-name="Content">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] min-w-full relative shrink-0 text-[18px] w-[min-content]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Access our documentation or reach out for custom integration requirements and support.
      </p>
    </div>
  );
}
...
function Actions5() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0" data-name="Actions">
      <div className="bg-black content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '#docs'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Docs
        </p>
      </div>
      <div className="content-stretch flex items-center justify-center px-[24px] py-[12px] relative shrink-0" data-name="Button" onClick={() => window.location.href = '#contact'} style={{cursor:'pointer'}}>
        <div aria-hidden="true" className="absolute border border-black border-solid inset-[-1px] pointer-events-none" />
        <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[16px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Contact
        </p>
...
export default function IntegrationsDesktop() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Integrations • Desktop">
      <Navbar />
      <Header1 />
      <Layout />
      <Layout2 />
