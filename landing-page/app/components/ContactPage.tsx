    ...
    <div className="size-full bg-[#0a0a0b] overflow-auto">
      ...
      <section className="pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-[800px] mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#F59E0B]/10 border border-[#F59E0B]/20 rounded-full mb-8">
      ...
      <section className="pb-20 px-6 md:px-12">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              {submitted ? (
                <div className="text-center py-12">
                  <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#F59E0B]/10 flex items-center justify-center">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 24 24"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-[#111113] border border-white/10 rounded-xl text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-[#F59E0B]/40 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-[#111113] border border-white/10 rounded-xl text-sm text-white focus:outline-none focus:border-[#F59E0B]/40 transition-colors appearance-none cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full px-4 py-3 bg-[#111113] border border-white/10 rounded-xl text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-[#F59E0B]/40 transition-colors resize-none"
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#F59E0B] text-[#0A0A0B] font-semibold rounded-xl hover:bg-[#F59E0B]/80 transition-colors"
                  >
                    Send Message
                  </button>
                </form>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Design partners CTA */}
            <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/20 rounded-2xl p-6">
              <h3 className="text-base font-semibold text-white mb-2">
                Become a Design Partner
              </h3>
              <p className="text-sm text-gray-400 mb-4">
                Get free early access, shape the product roadmap, and lock in
                preferred pricing.
              </p>
              <a
                href="mailto:jeff@ai-identity.co?subject=Design%20Partner%20Interest"
                className="inline-flex items-center gap-2 text-sm text-[#F59E0B] font-medium hover:underline"
              >
                Get in touch
                <svg
                  width="14"
